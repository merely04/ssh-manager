      ...
      <div className={styles.main}>
        <header className={styles.header}>
          ...
          <div className={styles.actions_list}>
            <button className={styles.button} onClick={openModal}>+ Добавить</button>
